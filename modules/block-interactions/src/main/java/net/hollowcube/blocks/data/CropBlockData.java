...
public record CropBlockData(@NotNull Material seedMaterial, @NotNull Material cropGrownMaterial,
                            @NotNull Block cropBlock, int maximumAge, boolean createAnotherBlock) {}
